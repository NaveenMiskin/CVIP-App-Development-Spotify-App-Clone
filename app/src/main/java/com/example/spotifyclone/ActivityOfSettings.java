    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        layout_home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(ActivityOfSettings.this,MainActivity.class);
        ...
        layout_search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(ActivityOfSettings.this, SearchingActivity.class);
                startActivity(intent);
                overridePendingTransition(R.anim.layout_fade_in,R.anim.layout_fade_out);
            }
        });
        ...
        layout_premium.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(ActivityOfSettings.this, ActivityOfPremium.class);
                startActivity(intent);
                overridePendingTransition(R.anim.layout_fade_in,R.anim.layout_fade_out);
            }
        });
        ...
        layout_goback.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ActivityOfSettings.this, ActivityOfLibrary.class);
                startActivity(intent);
                overridePendingTransition(R.anim.layout_fade_in,R.anim.layout_fade_out);
            }
        });
