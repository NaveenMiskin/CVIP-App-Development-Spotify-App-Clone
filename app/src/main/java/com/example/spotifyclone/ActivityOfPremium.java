...
public class ActivityOfPremium extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        layout_home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(ActivityOfPremium.this,MainActivity.class);
        ...
        layout_search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(ActivityOfPremium.this, SearchingActivity.class);
                startActivity(intent);
                overridePendingTransition(R.anim.layout_fade_in,R.anim.layout_fade_out);
            }
        });
        ...
        layout_library.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(ActivityOfPremium.this, ActivityOfLibrary.class);
                startActivity(intent);
                overridePendingTransition(R.anim.layout_fade_in,R.anim.layout_fade_out);
            }
        });
