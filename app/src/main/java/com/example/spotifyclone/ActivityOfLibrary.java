...
public class ActivityOfLibrary extends AppCompatActivity{
    LinearLayout layout_home,layout_search,layout_library,layout_premium;
    ImageView image_home,image_search,image_library,image_premium,image_settings;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        layout_home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(ActivityOfLibrary.this, MainActivity.class);
        ...
        layout_search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(ActivityOfLibrary.this, SearchingActivity.class);
                startActivity(intent);
                overridePendingTransition(R.anim.layout_fade_in,R.anim.layout_fade_out);
            }
        });
        ...
        layout_premium.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(ActivityOfLibrary.this, ActivityOfPremium.class);
                startActivity(intent);
                overridePendingTransition(R.anim.layout_fade_in,R.anim.layout_fade_out);
            }
        });
        ...
        image_settings.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ActivityOfLibrary.this, ActivityOfSettings.class);
                startActivity(intent);
                overridePendingTransition(R.anim.layout_fade_in,R.anim.layout_fade_out);
            }
        });
